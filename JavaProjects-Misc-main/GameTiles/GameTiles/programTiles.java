/**
 * programTiles is a test of JButtons and their modifiable characteristics.
 *
 * @author (your name)
...
public class programTiles extends JLabel implements MouseListener{
    ...
    public programTiles(int sideWidth, Color theColor) {
        this.addMouseListener(this);
        background = theColor;
